...
namespace Microsoft.TemplateEngine.Abstractions
{
    ...
    public interface ITemplateParameter
    {
        ...
        /// <summary>
        /// Gets the default value to be used if the parameter is not passed during template instantiation.
        /// </summary>
        ...
        /// <summary>
        /// Gets the default value to be used if the parameter is passed without value.
        /// </summary>
