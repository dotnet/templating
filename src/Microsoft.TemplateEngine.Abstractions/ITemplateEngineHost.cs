...
namespace Microsoft.TemplateEngine.Abstractions
{
    ...
    public interface ITemplateEngineHost
    {
        ...
        /// </returns>
        [Obsolete("The method is deprecated. If potentially destructive changes are detected without passing force, TemplateCreator will throw an error that can be processed by host.")]
