...
namespace Microsoft.TemplateEngine.Abstractions
{
    ...
    public interface IGenerator : IIdentifiedComponent
    {
        ...
        IReadOnlyList<ITemplate> GetTemplatesFromMountPoint(IMountPoint source);
        ...
        bool TryLoadTemplateFromTemplateInfo(IEngineEnvironmentSettings settings, ITemplateInfo config, out ITemplate? template, string? baselineName = null);
