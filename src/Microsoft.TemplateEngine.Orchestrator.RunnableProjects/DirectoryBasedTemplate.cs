...
namespace Microsoft.TemplateEngine.Orchestrator.RunnableProjects
{
    ...
    /// </summary>
    internal abstract partial class DirectoryBasedTemplate : ITemplateValidationInfo
    {
        ...
        /// </summary>
        protected DirectoryBasedTemplate(IEngineEnvironmentSettings settings, IGenerator generator, TemplateConfigModel configModel, IMountPoint sourceMountPoint)
        {
            EngineEnvironmentSettings = settings;
            //TODO: create specific logger if needed
            Logger = settings.Host.Logger;
            ...
            TemplateSourceRoot = sourceMountPoint.Root;
        ...
        /// </summary>
        protected IMountPoint SourceMountPoint { get; }
        ...
        /// </summary>
        protected IParameterDefinitionSet Parameters => ConfigModel.ExtractParameters();
        ...
        protected internal bool VerifyLocalizationModel(ILocalizationModel locModel, IFile localeFile)
        {
