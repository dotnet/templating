            ...
            get
            {
                if (_specialOperationConfig == null)
                {
                    List<SpecialOperationConfigParams> defaultSpecials = new List<SpecialOperationConfigParams>
                    {
                        ...
                        new SpecialOperationConfigParams("**/*.il", "//", "C++", ConditionalType.CLineComments),
                        ...
                        //It looks like these should have <?if ... ?>...<?endif?> style syntax, not sure the specific of the syntax yet
                        //new SpecialOperationConfigParams("**/*.wxi", "<!--/", "MSBUILD", ConditionalType.MSBuild),
                        //new SpecialOperationConfigParams("**/*.wxl", "<!--/", "MSBUILD", ConditionalType.MSBuild),
                        //new SpecialOperationConfigParams("**/*.wxs", "<!--/", "MSBUILD", ConditionalType.MSBuild),
                        ...
                        new SpecialOperationConfigParams("**/*.psess", "<!--", "C++", ConditionalType.Xml),
                        ...
                        //JSX & TSX comments are like this per http://chenglou.github.io/react/docs/jsx-in-depth.html
                        //   {/* child comment, put {} around */}
                        //new SpecialOperationConfigParams("**/*.jsx", "{/*", "C++", ConditionalType.CBlockComments),
                        //new SpecialOperationConfigParams("**/*.tsx", "{/*", "C++", ConditionalType.CBlockComments),
