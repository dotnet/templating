...
{
    internal class FolderManagedTemplatesPackage : IManagedTemplatesPackage
    {
        public FolderManagedTemplatesPackage(IEngineEnvironmentSettings settings, IInstaller installer, string mountPointUri)
        {
