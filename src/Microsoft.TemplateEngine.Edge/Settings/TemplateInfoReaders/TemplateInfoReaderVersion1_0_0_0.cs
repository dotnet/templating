    ...
    internal class TemplateInfoReaderVersion1_0_0_0
    {
        ...
        protected virtual ICacheTag ReadOneTag(JProperty item)
        {
            ...
            return new CacheTag(
                ...
                defaultValue: item.Value.ToString(nameof(ICacheTag.DefaultValue)),
                defaultIfOptionWithoutValue: item.Value.ToString(nameof(ICacheTag.DefaultIfOptionWithoutValue)));
        }
