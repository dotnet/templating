...
namespace Microsoft.TemplateSearch.TemplateDiscovery.PackChecking.Reporting
{
    ...
    {
        internal PackCheckResult(PackInfo packInfo, PreFilterResultList preFilterResults)
        {
            PackInfo = packInfo;
        ...
        internal PackCheckResult(PackInfo packInfo, IReadOnlyList<ITemplateInfo> foundTemplates)
        {
            PackInfo = packInfo;
        ...
        internal PackInfo PackInfo { get; }
