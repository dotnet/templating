...
namespace Microsoft.TemplateSearch.TemplateDiscovery.PackChecking.Reporting
{
    ...
    {
        public PackCheckResult(IPackInfo packInfo, PreFilterResultList preFilterResults)
        {
            PackInfo = packInfo;
        ...
        public PackCheckResult(IPackInfo packInfo, IReadOnlyList<ITemplateInfo> foundTemplates)
        {
            PackInfo = packInfo;
