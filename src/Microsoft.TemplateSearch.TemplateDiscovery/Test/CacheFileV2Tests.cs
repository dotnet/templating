...
{
    internal static class CacheFileV2Tests
    {
        public static void RunTests(string cacheFileV2Path)
        {
            ...
            UseSdkVersion(workingDirectory, requestedSdkVersion: "6.0.100-rc.1.21405.1", resolvedVersionPattern: "6.0.", rollForward: "latestFeature");
