...
```CSharp
    ...
    {
        internal HelloMacroConfig(HelloMacro macro, string variableName, string? dataType = null, string nameToGreet, string sourceVariable) : base(macro, variableName, dataType)
        {
