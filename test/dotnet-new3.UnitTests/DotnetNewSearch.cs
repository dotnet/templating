...
#pragma warning restore xUnit1004 // Test methods should not be skipped
        ...
        [InlineData("foo --search --columns-all --framework net7.0 bar", "bar|net7.0|foo", "--framework")]
        [InlineData("foo --search --columns-all -other-param --framework net7.0 bar", "bar|net7.0|--framework|foo", "-other-param")]
        [InlineData("search foo --columns-all bar", "bar", "foo")]
