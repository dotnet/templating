...
{
    internal class MockPackageManager : IDownloader, IUpdateChecker, IMetadataReader
    {
        ...
        public Task<(string Owners, bool Verified)> GetMigrationPackageMetadata(string packageIdentifier, PackageSource source, CancellationToken cancellationToken = default) => Task.FromResult((string.Empty, false));
