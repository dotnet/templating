...
//            IManagedTemplatesSource descriptor = new NupkgInstallUnitDescriptor(descriptorId, mountPointId, packageName, isOptional, version, author);
...
//                isOptional, details, out IManagedTemplatesSource descriptor));
//            Assert.Equal(descriptorId, descriptor.DescriptorId);
//            Assert.Equal(packageName, descriptor.Identifier);
//            Assert.Equal(NupkgInstallUnitDescriptorFactory.FactoryId, descriptor.FactoryId);
//            Assert.Equal(mountPointId, descriptor.MountPointId);
...
//            Assert.True(InstallUnitDescriptorFactory.TryParse(EngineEnvironmentSettings, descriptorProperty, out IManagedTemplatesSource parsedDescriptor));
