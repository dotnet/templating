...
namespace Microsoft.TemplateEngine.Cli.UnitTests.TemplateUpdateTests
{
    public class UpdateCheckerTests : TestBase
    {
        ...
        public void UpdateCheckerCorrectlyFindsUpdate()
        {
            ...
            IInstallUnitDescriptor unrelatedInstallDescriptor = new NupkgInstallUnitDescriptor(Guid.NewGuid(), unrelatedMountPointId, "unrelatedPackage", "2.0.0");
            ...
            IInstallUnitDescriptor testInstallDescriptor = new NupkgInstallUnitDescriptor(Guid.NewGuid(), mockMountPointId, "testPackage", "1.0.0");
