...
//            {
//                EvaluableMacros = new[] { new FailMacroConfig("test") }
//            };
...
//            var generatedSymbol = new GeneratedSymbol("s", "fail");
//            GlobalRunConfig config = new()
//            {
//                EvaluableMacros = new[] { new SwitchMacroConfig(new SwitchMacro(), generatedSymbol) }
//            };
...
//            GlobalRunConfig config = new()
//            {
//                EvaluableMacros = new[] { new UndeterministicMacroConfig(new UndeterministicMacro(), generatedSymbol) }
//            };
...
//            var generatedSymbols = new[] { new GeneratedSymbol("s", "undeterministic"), new GeneratedSymbol("p", "port"), new GeneratedSymbol("d", "now", jsonParameters) };

//            GlobalRunConfig config = new()
//            {
//                EvaluableMacros = generatedSymbols.Select(gs => new SwitchMacroConfig(new SwitchMacro(), gs)).ToArray()
//            };
...
//            GlobalRunConfig config = new()
//            {
//                //EvaluableMacros = new[] { (BaseMacroConfig)new UndeterministicMacroConfig(macro, "test"), new GuidMacroConfig("test-guid", "string", "Nn", "n") }
//            };
...
//            public UndeterministicMacroConfig(UndeterministicMacro macro, GeneratedSymbol symbol)
//                : base("undeterministic", symbol.Name, "string")
//            {
//                _macro = macro;
//            }
