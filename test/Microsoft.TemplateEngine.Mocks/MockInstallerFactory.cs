...
namespace Microsoft.TemplateEngine.Mocks
{
    public class MockInstallerFactory : IInstallerFactory
    {
        ...
        public IInstaller CreateInstaller(IManagedTemplatesSourcesProvider provider, IEngineEnvironmentSettings settings, string installPath) => throw new NotImplementedException();
    }
}
